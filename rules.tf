...
//the source of rules.tf file is  https://github.com/terraform-aws-modules/terraform-aws-security-group/blob/master/rules.tf

variable "rules" {
    description = "Rules for common services"
    type = map(any)
